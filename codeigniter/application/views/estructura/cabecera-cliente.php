...
<div class="topnav" id="myTopnav">
  <a href="http://localhost/cliente/" class="active"><img class="imagen-size" src="/imgs/logo-nav.png"></a>
  <a class="space-navs" href="http://localhost/cliente/perfil">Mi Perfil</a>
